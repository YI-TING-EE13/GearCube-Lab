...
[ Phase 3: Interactive UI, History & Scramble ] (Active Planning)
      ...
      └─ 3C: Keyboard Controls, Responsive Layout & Playwright Browser E2E (Preflight Planned)
      │
      ▼
...
- **Status:** `PLANNING / ACCEPTED` (Phase 3 Preflight, 3A, and 3B completed and accepted; Phase 3C preflight planned and ready for independent acceptance; formalized in [`docs/development/PHASE_3_IMPLEMENTATION_PLAN.md`](./PHASE_3_IMPLEMENTATION_PLAN.md)).
...
- **Subphases:**
  ...
  - **Phase 3C:** Keyboard Controls, Responsive Layout & Playwright Browser E2E (`useKeyboardControls.ts`, responsive CSS, `playwright.config.ts`, `tests/e2e/**`, human browser acceptance) — **Status:** `PLANNED / PREFLIGHT_READY_FOR_INDEPENDENT_ACCEPTANCE`.
